          ...
          <CardContent className="space-y-4">
            ...
            {meta && meta.pages > 1 ? (
              <div className="flex items-center justify-between pt-2 text-sm text-muted-foreground">
                <span>
                  Page {meta.page} of {meta.pages} · {meta.total} template{meta.total === 1 ? '' : 's'}
                </span>
                <div className="flex gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    disabled={meta.page <= 1 || templatesQuery.isFetching}
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    disabled={meta.page >= meta.pages || templatesQuery.isFetching}
